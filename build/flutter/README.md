...
* `grace_lyrics` - project identifier (lowercase, no spaces, i.e. "snake_case") used for bundle IDs and package names.
* `` - project description.
* `grace_lyrics` - executable or bundle name on disk.
* `grace_lyrics` - display name shown in window titles and about app dialogs.
